...
const eventsData = [
    ...
    },
    {
        ...
        description: 'STEM Inspires team offered an online App Development Course to elementary and middle school students. The students learned fun coding concepts with MIT App Inventor, an app development platform thats beginner-friendly. The session spanned 4 classes from mid December to mid January.',
